...
namespace GildedRose.Tests
{
    ...
    public class GildedRoseTest
    {
        ...
        [Test]
        public void UpdateQuality_BackstagePasses_QualityIncreaseBy2IfSellByBetween6and10(
            [Range(6, 10)] int startSellIn, [Random(0, 48, 10)] int startQuality)
        {
        ...
        [Test]
        public void UpdateQuality_BackstagePasses_QualityIncreaseBy3IfSellByBetween1and5([Range(1, 5)] int startSellIn,
            [Random(0, 47, 10)] int startQuality)
        {
            IList<Item> items = new List<Item>
            {
                new Item
        ...
        public void UpdateQuality_BackstagePasses_QualityIs0IfSellInIs0([Range(0, 50)] int startQuality)
        {
            IList<Item> items = new List<Item>
            {
                new Item {Name = "Backstage passes to a TAFKAL80ETC concert", SellIn = 0, Quality = startQuality}
            };
            var app = new GildedRose(items);
        ...
        public void UpdateQuality_Sulfuras_QualityDoesNotChange([Range(0, 50)] int startQuality)
        {
            IList<Item> items = new List<Item>
            {
                new Item {Name = "Sulfuras, Hand of Ragnaros", SellIn = 0, Quality = startQuality}
            };
            var app = new GildedRose(items);
        ...
        public void UpdateQuality_Sulfuras_SellInDoesNotChange([Random(1, int.MaxValue, 50)] int startSellIn)
        {
            IList<Item> items = new List<Item>
            {
                new Item {Name = "Sulfuras, Hand of Ragnaros", SellIn = startSellIn, Quality = 0}
            };
            var app = new GildedRose(items);
